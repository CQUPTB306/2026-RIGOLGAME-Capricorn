 ...
 * @note    总线1 (PCA9685+OLED): PA28(SDA) PA31(SCL) [I2C0_SDA + I2C1_SCL]
 *          总线2 (循迹):         PB03(SDA) PB02(SCL) [I2C1 全硬件]
 */
...
/*========== 总线实例 ==========*/
extern SoftI2C_Obj i2c_pca9685;   /* PA28(SDA) PA31(SCL) — PCA9685(0x40)+OLED(0x3C) */
