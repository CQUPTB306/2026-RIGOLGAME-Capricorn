...
/*
 * ⚠️ 右编码器: TIMG9 硬件 QEI — 不要改回软件解码!
 *   PB7(PINCM24 PF=0x07)=TIMG9_CCP0=A相
 *   PA2(PINCM7  PF=0x0D)=TIMG9_CCP1=B相
 *   改回 ENC2_USE_SOFTWARE=1 会导致右轮速度恒为 0 → PID 飞车
 */
#define ENC2_USE_SOFTWARE       0
...
#endif
#define QEI_RIGHT_PHA_PORT      GPIOB
#define QEI_RIGHT_PHA_PIN       DL_GPIO_PIN_7
#define QEI_RIGHT_PHB_PORT      GPIOA
#define QEI_RIGHT_PHB_PIN       DL_GPIO_PIN_2
