 ...
 *
 * 接线定义 (软件模拟 SPI, 所有 IOMUX 值来自 MSPM0 SDK):
 *  GND  -> 电源地
 *  VCC  -> 3.3V
 *  CLK  -> PB.18 (SPI 时钟)     PINCM44
 *  MOSI -> PB.19 (SPI 数据)     PINCM45
 *  CSN  -> PB.25 (片选)         PINCM56
 *  CE   -> PA.14 (数据/命令)    PINCM36
 *  RES  -> PB.17 (复位)         PINCM43
 *  BLK  -> 不使用 (背光接 VCC 常亮)
 */
 ...
 *===========================================================================*/
/* PB18 - CLK */
#define TFT_SCLK_PORT       GPIOB
#define TFT_SCLK_PIN        DL_GPIO_PIN_18
#define TFT_SCLK_IOMUX      IOMUX_PINCM44

/* PB19 - MOSI */
#define TFT_MOSI_PORT       GPIOB
#define TFT_MOSI_PIN        DL_GPIO_PIN_19
#define TFT_MOSI_IOMUX      IOMUX_PINCM45

/* PB17 - RES (复位) */
#define TFT_RES_PORT        GPIOB
#define TFT_RES_PIN         DL_GPIO_PIN_17
#define TFT_RES_IOMUX       IOMUX_PINCM43

/* PA14 - DC (Data/Command) */
#define TFT_DC_PORT         GPIOA
#define TFT_DC_PIN          DL_GPIO_PIN_14
#define TFT_DC_IOMUX        IOMUX_PINCM36
